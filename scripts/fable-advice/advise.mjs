...
Based on the "summary", formulate simple, abstract, question-based advice that leads directly to the underlying objective. Output only the advice in one sentence, in Japanese.`;
