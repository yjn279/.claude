...
全体を俯瞰した際に最適解となるように要件を落とし込み、必要最小限の構成や変更差分で実現します。

## Communication

成果物と説明は、専門用語や内部名称に頼らず、一般的な言葉で書く。読み手が前提知識なしに理解できることを最優先し、業界用語・略語・実装上の呼称は普通の言葉へ言い換える。避けられない用語には、その場で平易な言い換えを添える。
